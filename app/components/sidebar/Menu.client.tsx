    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'bg-white dark:bg-gray-950 border-r border-red-100 dark:border-red-800/50',
          'shadow-sm text-sm',
          isSettingsOpen ? 'z-40' : 'z-sidebar',
        )}
      >
        <div className="h-12 flex items-center justify-between px-4 border-b border-red-100 dark:border-red-800/50 bg-gray-50/50 dark:bg-gray-900/50">
