      ...
      <div className="relative flex w-full" onKeyDown={handleProviderKeyDown} ref={providerDropdownRef}>
        <div
          className={classNames(
            'modern-dropdown w-full p-2 rounded-lg border border-bolt-elements-borderColor',
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div
              className={classNames(
                'i-ph:caret-down w-4 h-4 text-bolt-elements-textSecondary opacity-75 transition-transform',
